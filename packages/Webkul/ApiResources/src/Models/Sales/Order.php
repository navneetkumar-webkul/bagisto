...
use Webkul\ApiResources\Models\Sales\OrderItem;
use Webkul\ApiResources\Models\Sales\Invoice;
use Webkul\ApiResources\Models\Sales\Shipment;
use Webkul\ApiResources\Models\Sales\OrderAddress;
use Webkul\ApiResources\Models\Sales\OrderComment;
use Webkul\ApiResources\Models\Sales\OrderPayment;
...
class Order extends \Webkul\Sales\Models\Order
{
    ...
    {
        return $this->hasMany(\Webkul\ApiResources\Models\Sales\DownloadableLinkPurchased::class);
    }
